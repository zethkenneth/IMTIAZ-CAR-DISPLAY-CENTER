...
import { Box, Button, ButtonGroup, Flex, Heading, HStack, Icon, Input, InputGroup, InputLeftElement, Text } from "@chakra-ui/react";
...
const InventoryNavBar = ({
  ...
  return (
    <Flex
      ...
      bg="gray.100"
    >
      <Heading size="lg" color='orange'>Inventory Management</Heading>
