      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg shadow-md">
          ...
          <p className="text-gray-700">
            Manage your inventory of brand new and second-hand cars, as well as
            auto parts with ease. Our system allows you to track stock levels,
            update product details, and streamline your inventory processes.
          </p>
        </div>
        ...
        <div className="p-4 bg-gray-100 rounded-lg shadow-md">
          ...
          <p className="text-gray-700">
            Keep track of your sales performance with our robust tracking tools.
            Analyze sales data, monitor trends, and generate reports to make
            informed decisions and improve your sales strategy.
          </p>
        </div>
        ...
        <div className="p-4 bg-gray-100 rounded-lg shadow-md">
          ...
          <p className="text-gray-700">
            ...
            tutorials, and step-by-step instructions to help you keep your cars
            in top condition and address common issues.
          </p>
        </div>
